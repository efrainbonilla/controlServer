...
use AppBundle\Form\ProductoMarcaType;
 ...
 * @RouteResource("ProductoMarca")
 */
class ProductoMarcaRESTController extends VoryxController
{
    /**
     * Get a ProductoMarca entity
     *
     ...
     *
     */
    public function getAction(ProductoMarca $entity)
    {
        return $entity;
    }
    /**
     * Get all ProductoMarca entities.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher, Request $request)
    {
        try {
            ...
            $entity = $em->getRepository('AppBundle:ProductoMarca');
            if (!empty($q)) {
                $filters_ = array(
                    'nomb' => '',
                );
    ...
    public function postAction(Request $request)
    {
        ...
        $form = $this->createForm(get_class(new ProductoMarcaType()), $entity, array("method" => $request->getMethod()));
     ...
     * @return Response
     */
    public function putAction(Request $request, ProductoMarca $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
    ...
    /**
     * Partial Update to a ProductoMarca entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function patchAction(Request $request, ProductoMarca $entity)
    {
        return $this->putAction($request, $entity);
    }
    /**
     * Delete a ProductoMarca entity.
     *
     * @View(statusCode=204)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function deleteAction(Request $request, ProductoMarca $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
            $em->remove($entity);
